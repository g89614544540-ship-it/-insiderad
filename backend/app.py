...
def upload_media():
    try:
        ...
        r = httpx.post(
            f"{SB_URL}/storage/v1/object/media/{path}",
...
.at2{font-size:52px;font-weight:800;color:#4a9eff;text-align:center;margin:16px 0}
...
.noads{text-align:center;padding:60px 20px}
